...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/29 16:33:31 by dorange-          #+#    #+#             */
/*   Updated: 2019/10/27 18:56:41 by dorange-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char					*ft_strncat(char *s1, const char *s2,
							size_t n);
size_t					ft_strlcat(char *dst, const char *str,
							size_t size);
...
t_list_fd				*ft_lstnew_fd(void const *cnt,
							size_t len, int fd);
...
t_list					*ft_lstswap(t_list *lst_1, t_list *lst_2,
							t_list *lst_front);
void					ft_lstaddnew(t_list **alst, void const *content,
							size_t content_size);
